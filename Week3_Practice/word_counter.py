...
def word_filter_counter(text, filter_words):
    answer = {}
    text_lower = text.lower()  # Convert filter_words to lowercase 
    words = re.findall(r'\b\w+\b', text.lower())    # Use regular expression to find all words in the text
    

    #  count frequency of filter_words
